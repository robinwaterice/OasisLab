...
export const PRODUCTS: Product[] = [
  {
    ...
    specifications: [
      { label: '材質', value: '航太級鋁合金 / 精紡羊毛氈 / 環保矽膠' },
      { label: '輸入接口', value: 'Type-C (支援 PD 30W 及以上)' },
      { label: '輸出功率', value: '手機 15W Max / 耳機 5W Max / 腕錶 3W Max' },
      { label: '尺寸重量', value: '148 x 92 x 120 mm / 340g' }
    ],
  ...
  },
  {
    ...
    specifications: [
      { label: '材質', value: '高強度鋼化玻纖 / 啞光鋁質邊框' },
      { label: '厚度尺寸', value: '85.6 x 54 x 1.6 mm (標準信用卡尺寸)' },
      { label: '連接技術', value: 'Bluetooth BLE / Apple Find My 認證晶片' },
      { label: '電池壽命', value: '內置超薄不可充電池，可連續運作約 3 年' }
    ],
  ...
  },
  {
    ...
    specifications: [
      { label: '材質', value: '特選有田燒陶瓷 / 北美胡桃木 / 高硼矽耐熱玻璃' },
      { label: '適用容量', value: '1-2 人份 (約 300-400ml)' },
      { label: '耐熱溫度', value: '陶瓷濾杯無限制 / 分享壺耐溫差 150°C' },
      { label: '產地來源', value: '日本佐賀縣有田町手作' }
    ],
  ...
  },
  {
    ...
    specifications: [
      { label: '材質', value: 'BASF 慢回彈記憶棉 / 聚酯纖維蜂巢網布' },
      { label: '尺寸大小', value: '420 x 380 x 120 mm' },
      { label: '適用場景', value: '辦公椅、人體工學椅、汽車駕駛座' },
      { label: '保固期限', value: '內芯提供 3 年非人為塌陷保固' }
    ],
  ...
  },
  {
    ...
    specifications: [
      { label: '材質', value: 'Cordura® 彈道尼龍 / YKK 防水拉鍊 / 鋁合金搭扣' },
      { label: '收納容量', value: '18L (可容納最高 16 吋 MacBook Pro)' },
      { label: '防護等級', value: '防潑水、防撕裂，全包防水拉鍊' },
      { label: '尺寸重量', value: '450 x 300 x 140 mm / 820g' }
    ],
  ...
  },
  {
    ...
    specifications: [
      { label: '材質', value: '醫療級 316 不鏽鋼內膽 / 304 不鏽鋼瓶身 / 食品級矽膠' },
      { label: '容量大小', value: '480 ml' },
      { label: '顯示技術', value: 'LED 高靈敏觸控面板 (內置長效免充電池)' },
      { label: '保溫效果', value: '6 小時 > 68°C，保冷 6 小時 < 8°C' }
    ],
  ...
  },
  {
    ...
    specifications: [
      { label: '材質', value: '美麗諾羊毛氈 / 天然碳化橡木皮 / 防滑橡膠' },
      { label: '尺寸厚度', value: '800 x 300 mm，厚度約 5 mm' },
      { label: '清潔方式', value: '局部濕抹布擦拭，支援羊毛專用清洗' },
      { label: '環保屬性', value: '100% 可降解天然材質，無異味無甲醛' }
    ],
  ...
  },
  {
    ...
    specifications: [
      { label: '材質', value: '防過敏親膚樹脂 / 航空級磨砂鋁合金' },
      { label: '藍牙版本', value: 'Bluetooth 5.3 (支援雙設備流暢切換)' },
      { label: '降噪深度', value: '智慧主動降噪 45dB / 支援通透模式' },
      { label: '續航時間', value: '耳機 7 小時 / 搭配充電倉總計約 30 小時' }
    ],
  ...
  },
  {
    ...
    specifications: [
      { label: '主成分', value: '純水 (RO 逆滲透過濾水) 99% 以上' },
      { label: '適用對象', value: '全年齡層適用，嬰兒級安全認證' },
      { label: '材質規格', value: '加厚棉紗布 / 無紡布複合纖維' },
      { label: '購買平台', value: 'momo 購物網 (原廠正品授權)' }
    ],
